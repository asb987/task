...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link <?php $uri = service('uri'); if($uri->getSegment(1)!='dashboard'){echo 'collapsed';}?>" href="<?= base_url();?>/dashboard">
      ...
      <li class="nav-item">
        <a class="nav-link <?php $uri = service('uri'); if($uri->getSegment(1)!='add_contact'){echo 'collapsed';}?>" href="<?= base_url();?>/add_contact">
